...
values('$name','$category_name','$subcategory','$oldprice','$price','$description','$image','$rating','$brandname','$type')";
if ($db->query($sql) === TRUE) {
$successMSG ="New record created successfully";
header("refresh:0.1; allproducts.php");
} else {
$errMSG="Error: " . $sql . "
<br>" . $db->error;
}
  ...
  <form method="post"  enctype="multipart/form-data" class="form-horizontal">
    <fieldset>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="declineType">ProductName
        </label>
        <div class="col-md-4">
      ...
      <!-- Select Basic -->
      <div class="form-group">
        <label class="col-md-4 control-label" for="declineType">MainCategory
        </label>
        <div class="col-md-4">
...
?>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="declineType">SubCategory
        </label>
        <div class="col-md-4">
...
?>
      ...
      <!-- Textarea -->
      <div class="form-group">
        <label class="col-md-4 control-label" for="dis">Description
        </label>
        <div class="col-md-4">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="date">OldPrice
        </label>
        <div class="col-md-4">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="date">Price
        </label>
        <div class="col-md-4">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="ln">Image
        </label>
        <div class="col-md-4">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="where">Type
        </label>
        <div class="col-md-4">
          <select id="where" name="type" class="form-control">
            <option value="bannerimage">Banner Image
            </option>
            <option value="normalimage">Normal Image
            </option>
          </select>
        </div>
      </div>
      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label" for="date">Rating
        </label>
        <div class="col-md-4">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="date">BrandName
        </label>
        <div class="col-md-4">
