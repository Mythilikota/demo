...
<div class="col-md-10 h well">
  <form method="post" enctype="multipart/form-data"  class="form-horizontal">
    <fieldset>
      <!-- Form Name -->
      <legend>Add New SubCategory
      </legend>
      <div class="form-group">
        <label class="col-md-4 control-label" for="textinput">SubCategory:
        </label>  
        <div class="col-md-4">
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="textinput">MainCategory:
        </label>  
        <div class="col-md-4">
...
?>
            <option title='<?php echo $row['categoryname']; ?>' value='<?php echo $row['categoryname']; ?>'>
