...
?>
      <div>
        <form class="form-horizontal"  method = "POST" enctype = "multipart/form-data"  >
          ...
          <div class="form-group">
            <label for="inputPassword" class="control-label col-xs-2">Oldprice
            </label>
            <div class="col-xs-5">
          ...
          <div class="form-group">
            <label for="inputPassword" class="control-label col-xs-2">Price
            </label>
            <div class="col-xs-5">
          ...
          <div class="form-group">
            <label for="inputPassword" class="control-label col-xs-2">description
            </label>
            <div class="col-xs-5">
          ...
          <div class="form-group">
            <label for="inputPassword" class="control-label col-xs-2">rating
            </label>
            <div class="col-xs-5">
          ...
          <div class="form-group">
            <label for="inputPassword" class="control-label col-xs-2">brandname
            </label>
            <div class="col-xs-5">
          ...
          <div class="form-group">
            <label for="inputPassword" class="control-label col-xs-2">Type
            </label>
            <div class="col-xs-5">
          ...
          <div class="form-group">
            <label class="col-xs-2 control-label" for="declineType">MainCategory
            </label>
            <div class="col-xs-5">
...
extract($list);
?>
                <option title='<?php echo $list['categoryname'];?>' value="<?php echo $list['categoryname'];?>">
          ...
          <div class="form-group">
            <label class="col-xs-2 control-label" for="declineType">SubCategory
            </label>
            <div class="col-xs-5">
...
extract($list);
?>
                <option title='<?php echo $list['subcategory'];?>' value="<?php echo $list['subcategory'];?>">
