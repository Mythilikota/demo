	...
	public function index() 
	{
		...
		{ 		
				...
				//print_r($dataarray->boardingPoints);
					...
					{
						$url = 'http://test.etravelsmart.com/etsAPI/api/getBusLayout?sourceCity='.$hidfrom.'&destinationCity='.$hidto.'&doj='.$hiddate.'&inventoryType='.(string)$dataarray->inventoryType.'&routeScheduleId='.(string)$dataarray->routeScheduleId;	
						...
						curl_setopt($ch, CURLOPT_USERPWD, $LoginID.":".$Password); // username and password - declared at the top of the doc
