...
<!------- Including CSS File ------>
  ...
  <div class="form-group">
        <label for="inputPassword" class="control-label col-xs-2">Image2: </label>
        <div class="col-xs-5">
           <input type="hidden"  name="image1" placeholder="Enter Name"  value="<?php echo $list['image2'];?>" />  <input type="file" required  name="Image" />
    ...
    <div class="form-group">
	  ...
	  <form class="form-horizontal"  method = "POST" enctype = "multipart/form-data"  >
	<div class="form-group">
        <label for="inputPassword" class="control-label col-xs-2">Image3: </label>
        <div class="col-xs-5">
           <input type="hidden"  name="image1" placeholder="Enter Name"  value="<?php echo $list['image3'];?>" />  <input type="file" required  name="Image" />
