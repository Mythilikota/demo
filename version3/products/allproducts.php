	...
	?>
       <tr>
        ...
        <td class=""><?php echo $list["name"]; ?></td>
          ...
          <td><?php echo $list["oldprice"]; ?></td>
		  <td><?php echo $list["price"]; ?></td>
          
		  <td><?php echo $list["rating"]; ?></td>
		   <td><?php echo $list["brandname"]; ?></td>
		   <td><?php echo $list["type"]; ?></td>
                    <td><img src="../uploads/<?php echo $list['image']; ?>" class="img-rounded" width="50px" height="50px" /></td>
		     <td><a  href="../products/addimage.php?id=<?php echo $list["id"]; ?>">AddImage </a>
             </td>
           <td><a class="btn btn-primary" href="../products/editproducts.php?id=<?php echo $list["id"]; ?>"> <span class="glypicon glyphicon glyphicon-pencil"></span></a>
             </td>
			 <td><a class="btn btn-primary" href="../products/editimage.php?id=<?php echo $list["id"]; ?>"> <span class="glypicon glyphicon glyphicon-pencil"></span></a>
             </td>
            <td><a class="btn btn-danger" href="../products/deleteproducts.php?id=<?php echo $list["id"]; ?>"><span class="glyphicon glyphicon-trash"></span></a></td> 
        </tr>
<?php 
}
?>
